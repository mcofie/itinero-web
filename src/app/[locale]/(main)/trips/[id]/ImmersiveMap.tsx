...
export function ImmersiveMap({
    ...
    return (
        <div className="relative h-[calc(100vh-250px)] w-full overflow-hidden rounded-[2rem] border border-slate-200 shadow-sm dark:border-slate-800">
            <LeafletMap
                day={fakeDay}
            ...
            <div className="absolute bottom-6 left-6 z-[400] rounded-2xl bg-white/90 px-4 py-2 text-xs font-bold shadow-lg backdrop-blur-md dark:bg-slate-900/90 dark:text-white">
