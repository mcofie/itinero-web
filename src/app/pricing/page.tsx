            ...
            <section className="border-y border-border bg-gradient-to-b from-primary/10 via-background to-background">
                <div className="mx-auto w-full max-w-6xl px-6 py-14 md:py-20">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <div className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl border border-border bg-card text-card-foreground px-3 py-2 text-sm ring-4 ring-primary/10">
            ...
            <section className="mx-auto w-full max-w-6xl px-6 pb-10 md:pb-14">
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {PACKS.map((pack) => (
                        <Card
                            key={pack.id}
                            className={`relative ${pack.best ? "ring-2 ring-primary/30" : ""}`}
                        >
                            {pack.best && (
            ...
            <section className="mx-auto w-full max-w-4xl px-6 pb-20">
                ...
                <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="fx">
                        ...
                        <AccordionContent>
                            We show an approximate GHS value for clarity. Your final price is auto-converted at checkout using current FX.
                    ...
                    <AccordionItem value="refunds">
                        ...
                        <AccordionContent>
                            If something breaks or your itinerary fails to generate, we’ll either regenerate it or refund credits.
                    ...
                    <AccordionItem value="collab">
                        ...
                        <AccordionContent>
                            Collaborative editing is in beta and currently free. You can invite a friend to co-edit shortly after creation.
                        </AccordionContent>
                    </AccordionItem>
                </Accordion>

                <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row sm:justify-between rounded-xl border border-border bg-card text-card-foreground px-4 py-3">
