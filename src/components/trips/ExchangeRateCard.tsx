            ...
            <div className="relative z-10 flex flex-col gap-6">
                <div className="flex items-center justify-between text-emerald-50">
                    ...
                    {loading ? (
                        ...
                        <div className="flex items-center gap-1 text-[10px] font-medium opacity-60 bg-black/10 px-2 py-0.5 rounded-full">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative flex-1">
                            <Input
                                ...
                                placeholder="0"
                            />
                            <span className="absolute right-4 top-1/2 -translate-y-1/2 text-xs font-bold text-emerald-100">
                                {baseCurrency}
                            </span>
                        </div>
                ...
                {snapshot && converted !== null && (
                    <div className="text-[10px] font-medium text-emerald-100/60 text-center border-t border-white/10 pt-3">
